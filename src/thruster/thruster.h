...
public:
	 ...
	 */
	auto get_pos() -> Eigen::Vector3d & { return m_pos_m; }
	 ...
	 */
	auto get_force() -> double & { return m_force_N; }
	 ...
	 */
	auto get_output() -> double { return m_throttle * m_force_N; }
...
private:
	...
	Eigen::Vector3d m_pos_m{Eigen::Vector3d(0, 0, 0)};
